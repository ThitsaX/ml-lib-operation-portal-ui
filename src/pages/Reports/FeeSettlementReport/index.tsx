...
const initialFileName = 'MT971FeeSettlementReport';

const FeeSettlementReport = () => {
  ...
  return (
    ...
    <VStack align="flex-start" w="full" h="full" p="3" mt={10}>
      <Stack>
        <Heading fontSize="2xl" fontWeight="bold" mb={6}>{t('ui.fee_settlement_report')}</Heading>
      </Stack>
...
export default memo(FeeSettlementReport);
